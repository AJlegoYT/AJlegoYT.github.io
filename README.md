...
<body>
    ...
    <script>
        ...
        function renderMiddleDisplay() {
            ...
            const displayCount = trooperCount; // No limit!
        ...
        function updateMiddleDisplayIfNeeded() {
            const currentDisplayCount = Math.floor(troopers);
            const previousDisplayCount = trooperPositions.length;
